...
<!-- TYPING SVG -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=2800&pause=900&color=00C9A7&center=true&vCenter=true&width=700&lines=MCA+Student+%40+VIT+Chennai;Java+%7C+C%2FC%2B%2B+%7C+DSA+%7C+OOP+%7C+SQL;Full-Stack+MERN+Developer;Building+ML-powered+%26+Full-Stack+apps+%F0%9F%9A%80" alt="Typing SVG" />
...
> Replace `your-leetcode-username` below with your actual LeetCode handle to activate this card.

<div align="center">

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://leetcard.jacoblin.cool/your-leetcode-username?theme=dark&font=Fira+Code&ext=heatmap" />
  <source media="(prefers-color-scheme: light)" srcset="https://leetcard.jacoblin.cool/your-leetcode-username?theme=light&font=Fira+Code&ext=heatmap" />
  <img src="https://leetcard.jacoblin.cool/your-leetcode-username?theme=light&font=Fira+Code&ext=heatmap" alt="LeetCode Stats" />
</picture>
...
**ML pipeline + real-time deployment**

Built an end-to-end ML pipeline on the EMSCAD dataset spanning 9 classical ML models and 4 deep learning models (LSTM, BiLSTM, CNN, CNN-BiLSTM), trained on GPU. Deployed with real-time prediction, a confidence-score gauge, and explainability.

`Python` `Scikit-learn` `TensorFlow/Keras` `Streamlit` `NLP (TF-IDF)`

🔗 [fake-job-detection-by-prince.streamlit.app](https://fake-job-detection-by-prince.streamlit.app)

</td>
<td width="50%" valign="top">

### 🎙️ Meeting Summarizer
**ASR transcription + LLM summarization**

Full-stack meeting summarization tool using faster-whisper ASR for transcription and a Groq LLM API for automated summaries, with clickable timestamp navigation, PDF export, and calendar (.ics) export.

`Python` `Streamlit` `faster-whisper` `Groq API` `REST APIs`

🔗 [meeting-summarizer-by-princebhandari22.streamlit.app](https://meeting-summarizer-by-princebhandari22.streamlit.app)
...
### 🎓 CourseHub
**Full-stack course selling platform (MERN)**

Full-stack MERN web application with secure JWT-based authentication and a complete instructor-to-student purchase flow, including a token-based forgot-password flow with email delivery.

`React.js` `Node.js` `Express.js` `MongoDB` `JWT` `Cloudinary`

🔗 [course-hub-peach.vercel.app](https://course-hub-peach.vercel.app)
...
From ML systems to real-time tools to full-stack platforms — explore the full body of work, issues resolved, and production debugging along the way.

`Full-Stack` `Applied ML` `Debugging` `Deployment`

🔗 [github.com/princebhandarii](https://github.com/princebhandarii)
...
|---|---|---|---|
| Master of Computer Applications (MCA) | VIT Chennai | 2025 – 2027 (Pursuing) | CGPA 8.81/10 |
| Bachelor of Computer Applications (BCA) | VNSGU | 2021 – 2024 | 85.80% |
